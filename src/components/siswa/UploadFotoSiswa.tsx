                ...
                return (
                  ...
                  >
                    ...
                    <div className="p-4 flex flex-col items-center text-center">
                      ...
                      >
                        <img
                          src={student.avatar || `https://api.dicebear.com/7.x/bottts/svg?seed=${encodeURIComponent(student.nisn || student.name)}`}
                          alt={student.name}
                ...
                {filteredStudents.map((s, idx) => (
                  ...
                  >
                    <div className="w-20 h-26 bg-slate-200 rounded-lg overflow-hidden border border-slate-300 shadow-2xs mb-2">
                      <img
                        src={s.avatar || `https://api.dicebear.com/7.x/bottts/svg?seed=${encodeURIComponent(s.nisn || s.name)}`}
                        alt={s.name}
                        className="w-full h-full object-cover"
                        referrerPolicy="no-referrer"
                      />
